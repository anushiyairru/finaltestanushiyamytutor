...
<body>
    ...
    <section>
        ...
        <div class="w3-padding">
            <table class="w3-table w3-striped w3-bordered">
                ...
                <?php $__currentLoopData = $subitemlists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subitemlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>

                    <td><?php echo e($subitemlist->id); ?></td>
                    <td><?php echo e($subitemlist->subject_title); ?></td>
                    <td><?php echo e($subitemlist->subject_description); ?></td>
                    <td><?php echo e($subitemlist->subject_price); ?></td>
                    <td><?php echo e($subitemlist->subject_learningHours); ?></td>
                </tr>
    ...
    <div id="newsubject" class="w3-modal w3-animate-opacity">
        <div class="w3-modal-content w3-round" style="width:500px">
            ...
            <div class="w3-padding">
                <form action="<?php echo e(route('subjectregister')); ?>" method="post">
...
</html><?php /**PATH C:\Users\User\Documents\GitHub\laravel\finaltestanushiyamyTutor\resources\views/mainpage.blade.php ENDPATH**/ ?>